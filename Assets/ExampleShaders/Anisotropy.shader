    ...
    SubShader
    {
        ...
        Pass
        {
						...
						)
			{
				...
				float2 uv022 = packedInput.ase_texcoord5.xy * float2( 8,8 ) + float2( 0,0 );
...
#ifdef _MATERIAL_FEATURE_ANISOTROPY
				surfaceDescription.Anisotropy = ( tex2D( _AnisotropyMap, uv022 ).b * _AnisotropyStrength );
#endif
        ...
        Pass
        {
			...
			float4 Frag ( PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv022 = packedInput.ase_texcoord.xy * float2( 8,8 ) + float2( 0,0 );
...
/*ASEBEGIN
Version=16705
473;73;788;556;529.6711;250.6228;1;True;False
...
ASEEND*/
//CHKSM=547608341C05001ADE06DB453A07DB02806DD375
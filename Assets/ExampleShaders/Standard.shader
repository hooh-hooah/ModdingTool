    ...
    SubShader
    {
        ...
        Pass
        {
						...
						)
			{
				...
				float2 uv016 = packedInput.ase_texcoord5.xy * float2( 2,2 ) + float2( 0,0 );
				
				surfaceDescription.Albedo = ( tex2D( _BaseColor, uv_BaseColor ) * tex2D( _MixAlbedo, uv016 ) ).rgb;
				surfaceDescription.Normal = UnpackNormalmapRGorAG( tex2D( _Normal, uv016 ), 1.0f );
				surfaceDescription.Emission = 0;
				surfaceDescription.Specular = 0;
				surfaceDescription.Metallic = tex2D( _Metallic, uv016 ).r;
				surfaceDescription.Smoothness = ( 1.0 - ( _RoughnessScale * tex2D( _Sand_roughness, uv016 ).r ) );
        ...
        Pass
        {
			...
			float4 Frag ( PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv016 = packedInput.ase_texcoord.xy * float2( 2,2 ) + float2( 0,0 );
...
/*ASEBEGIN
Version=16705
473;73;788;556;862.9405;487.2272;2.101362;True;False
...
ASEEND*/
//CHKSM=4CB4AC8F0AA3DBAF988C897F9E84F29F89B2E550
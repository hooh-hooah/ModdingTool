...
public class FolderAsset
{
    ...
    {
        private readonly Dictionary<string, (SerializedProperty, Object)> data =
            new Dictionary<string, (SerializedProperty, Object)>();
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (!data.TryGetValue(propertyPropertyPath, out var tuple))
            {
                ...
                data[propertyPropertyPath] = tuple = (guid,
                    AssetDatabase.LoadAssetAtPath<Object>(AssetDatabase.GUIDToAssetPath(guid.stringValue)));
            }

            var guiContent = EditorGUIUtility.ObjectContent(tuple.Item2, typeof(DefaultAsset));

...
public class ClothComponentEditor : CustomComponentBase
{
    ...
    protected override void DrawCustomInspector()
    {
        ...
        if (clothComponent.objTopDef == null && clothComponent.objBotDef == null && clothComponent.objTopHalf == null &&
            ...
            EditorGUILayout.HelpBox(
                "Nothing is assigned to objTop/objBot - This is critical if you're making top/bottom outfit.",
                MessageType.Warning);
    ...
    private enum ClothEvent { ResetMaterial, ResetComponent, AssignDynamicBone }
}
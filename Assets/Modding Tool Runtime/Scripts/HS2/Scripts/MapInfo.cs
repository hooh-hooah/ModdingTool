...
public class MapInfo : ScriptableObject
{
    ...
    public class Param
    {
        ...
        private static readonly int[] ReservedMapSlots =
            {0, 1, 2, 3, 4, 100, 101, 102, 103, 5, 6, 7, 8, 9, 10, 12, 13, 14, 15, 50, 51, 52, 53, 16, 500};

        public static readonly int[] DefaultADVEventCategories =
            {-1, 0, 1, 2, 10, 11, 16, 18, 19, 20, 21, 23, 24, 25, 26, 27, 33};

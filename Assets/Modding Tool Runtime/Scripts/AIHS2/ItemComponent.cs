...
namespace Studio
{
    ...
    public class ItemComponent : MonoBehaviour
    {
                ...
                var rendererInfo = new RendererInfo
                {
                    ...
                    materials = rendererComponent.sharedMaterials.Select(material =>
                    {
                        var matInfo = new MaterialInfo
                        {
                            ...
                            isAlpha = material.shader.name
                                .Contains(
                                    "Alpha"), // TODO: make this as utility and better detection of transparent shader.
                            isGlass = false, // Glass? 
        ...
        {
            foreach (var targetComponent in Selection.objects.OfType<GameObject>()
                .Select(x => x.GetComponent<ItemComponent>()).Where(x => x != null))
            {

...
public class NavMeshSourceTag : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        {
            m_Meshes.Add(gameObject, new Info {MeshFilter = component, NavMeshModifier = GetComponent<NavMeshModifier>()});
        }
        else
        {
    ...
    {
        sources.Clear();
        var enumerable = from v in m_Meshes.Values where v.MeshFilter != null where v.MeshFilter.sharedMesh != null where !v.Ignore select v;
    ...
    public class Info
    {
        ...
        public bool Ignore
        {
            [CompilerGenerated] get => NavMeshModifier && NavMeshModifier.isActiveAndEnabled & NavMeshModifier.ignoreFromBuild;
        }

        public bool OverrideArea
        {
            [CompilerGenerated] get => NavMeshModifier && NavMeshModifier.isActiveAndEnabled & NavMeshModifier.overrideArea;
        }

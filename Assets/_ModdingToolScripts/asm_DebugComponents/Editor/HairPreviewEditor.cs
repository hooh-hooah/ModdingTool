...
namespace DebugComponents.Inspectors
{
    ...
    public class HairPreviewEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button("Initialize")) hairPreviewComponent.LoadAndSetTexture();
            if (GUILayout.Button("Assign Textures")) hairPreviewComponent.SetupTextureBasedDirectory();
            GUILayout.EndHorizontal();
